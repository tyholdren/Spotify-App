...
class SearchButtons extends Component {
  constructor(props) {
    ...
    this.handleViewPlaylistButtonClick =
      this.handleViewPlaylistButtonClick.bind(this);
    this.handleAddSongButtonClick = this.handleAddSongButtonClick.bind(this);
    this.handleUpdateSongButtonClick =
      this.handleUpdateSongButtonClick.bind(this);
    this.handleDeleteSongButtonClick =
      this.handleDeleteSongButtonClick.bind(this);
    this.handleClearPlaylistButtonClick =
      this.handleClearPlaylistButtonClick.bind(this);
  }
  ...
  render() {
    return (
      <div className="buttonsContainer">
        <button onClick={this.handleViewPlaylistButtonClick}>
          View Playlist
        </button>
        ...
        <button onClick={this.handleDeleteSongButtonClick}>
          Delete Artist
        </button>
        <button onClick={this.handleClearPlaylistButtonClick}>
          Clear Playlist
        </button>
